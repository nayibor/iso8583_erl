%%%
%%% @doc yapp_test_ascii_post module.
%%%<br>this module contains specs for postillion</br>
%%% @end
%%% @copyright Nuku Ameyibor <nayibor@startmail.com>


-module(iso8583_ascii_post).
...
%%have to add a function here which returns the various messages and the optional/mandatory fields for each message for this spec 
