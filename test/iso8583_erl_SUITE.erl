...
-export([pack_data/1,set_field/1,unpack_data/1,unpack_data_secodary_bitmap_message/1,unpack_data_primary_bitmap_message/1,
         process_data_element/1,create_bitmap_binary/1,create_bitmap_hex/1,create_bitmap_spec/1,get_bitmap_subs/1,pack_data_2/1]).



all() -> [pack_data,set_field,unpack_data,unpack_data_secodary_bitmap_message,unpack_data_primary_bitmap_message,
		 process_data_element,create_bitmap_binary,create_bitmap_hex,create_bitmap_spec,get_bitmap_subs,pack_data_2].
...
init_per_testcase(_, Config) ->
	...
	ct:pal("~n Spec path is ~p",[Spec_path]),
...
set_field(_Config)->
	...
	?assertEqual(true,#{3 => <<"201234">>,4 => <<"123456789012">>,5 => <<"5000">>,mti => <<"0200">>} =:= Fourth_map).
...
unpack_data_secodary_bitmap_message(Config)->
	Specification =?config(spec, Config),
	Result = 
	 #{2 => <<"1231231312">>,4 => <<"0000001000.5">>,7 => <<"1107221800">>,11 => <<"000001">>,
